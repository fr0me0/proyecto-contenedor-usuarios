package org.frandevs.jdbc.proyectocontenedor;

import org.frandevs.jdbc.proyectocontenedor.modelo.Usuario;
import org.frandevs.jdbc.proyectocontenedor.repositorio.Repositorio;
import org.frandevs.jdbc.proyectocontenedor.repositorio.UsuarioRepositorioImpl;
import org.frandevs.jdbc.proyectocontenedor.util.ConexionBaseDatos;
        ...
        try ( Connection conn = ConexionBaseDatos.getInstance()) {
            ...
            do {
                ...
                Object opcion = JOptionPane.showInputDialog(null,
                        "Seleccione un Operación", "Contenedor de Usuario", JOptionPane.INFORMATION_MESSAGE, null, opArreglo, opArreglo[0]);
